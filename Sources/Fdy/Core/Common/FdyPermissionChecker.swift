...
public enum FdyPermissionType {
    ...
    case adTracking
    /// 位置
    case location(LocationFdyPermissionType)
    /// 通知
    case notification(options: UNAuthorizationOptions)

    /// 位置权限请求类型
    public enum LocationFdyPermissionType {
        /// 使用时
        case whenInUse
        /// 一直
        case always
...
private extension FdyPermissionChecker {
    ...
    func requestLocation(type: FdyPermissionType.LocationFdyPermissionType, completion: @escaping FdyAction1<FdyPermissionResult>) {
